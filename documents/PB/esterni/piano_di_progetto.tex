% changelog: "1.4.0, 2024-08-14, Veronica Tecchiati, Stesura sezioni 3 e 4"
...
\end{itemize}
%ABBIAMO FINITO LA RTB IL 21/06 ANZICHè ENTRO IL 07/06. è MEGLIO AGGIORNARE IL CALENDARIO (METTENDO UNA NUOVA STESURA AL xx/yy DATA INVENTATA, ANTECEDENTE AL 07/06, IN CUI SI SPOSTA LA SCADENZA RTB AL 21/06) O METTERE IL SESTO PERIODO IN UNA SEZIONE APPOSITA DENOMINATA "TRA RTB E PB" COME HANNO FATTO GLI SWAT? 
...
\subsection{Stima al 2024-03-26}
...
\begin{table}[ht!]   
	...
	\begin{tabular}{C{2.7cm} C{2.7cm} C{2.7cm} C{3.2cm}}
		...
		\bottomrule
		\\& Totale costo (\texteuro) \textbf{11430} & Totale ore (h) \hspace{1em} 570 & Tot. ore membro (h) 95 
	\end{tabular}
	\caption{Stima dei costi al 2024-03-26.}
	\label{table:Stima dei costi al 2024-03-26}
\end{table} 
\setlength\parindent{0em}
Il costo totale del progetto ammonta a 11430 \texteuro, che viene considerato come limite invalicabile del budget a disposizione. Qualora vi fosse il rischio di superare tale limite, vi sarà una rinegoziazione dei requisiti tra il gruppo fornitore ed il cliente.
\newpage
...
\end{table}
\subsubsubsection{Rischi occorsi, impatto e loro mitigazione} \\
Come previsto, i vari membri del team hanno dedicato minor tempo al completamento dei documenti rimasti per potersi focalizzare sul collaudo finale del progetto con la Proponente. Indi, nello Sprint successivo e finale, il team si occuperà esclusivamente del completamento della documentazione.
\subsubsection{Retrospettiva}
