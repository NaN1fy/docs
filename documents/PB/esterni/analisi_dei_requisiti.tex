% changelog: "1.2.0, 2024-08-10, Stesura UC-0, UC-1 e UC-3.12. Aggiunta requisiti, Veronica Tecchiati"
...
\begin{table}[ht!]	
	...
	\begin{tabular}{p{1.2cm} p{2cm} p{5cm} p{3cm} p{3cm}}
		...
		\midrule
                1.2.0 & 2024-08-10 & Stesura UC-0, UC-1 e UC-3.12. Aggiunta requisiti. & Veronica Tecchiati & - \\\\
...
\begin{itemize}
    ...
    \item \textbf {Specializzazioni:} [UC-\theuc .1], [UC-\theuc .2], [UC-\theuc .3], [UC-\theuc .4], [UC-\theuc .5], [UC-\theuc .6], [UC-\theuc .7], [UC-\theuc .8], [UC-\theuc .9], [UC-\theuc .10], [UC-\theuc .11];
    \item \textbf{Estensioni:} [UC-7].
\end{itemize}
\begin{figure}[ht!]
    \centering
