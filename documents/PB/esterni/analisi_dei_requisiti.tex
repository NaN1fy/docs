% changelog: "1.1.0, 2024-08-08, Correzioni in seguito alla valutazione RTB"
...
\begin{table}[ht!]	
	...
	\begin{tabular}{p{1.2cm} p{2cm} p{5cm} p{3cm} p{3cm}}
		...
		\midrule
			1.1.0 & 2024-08-08 & Correzioni in seguito alla valutazione RTB. & Oscar Konieczny & -
 		    \\ % spazio tra le righe
		\bottomrule
	\end{tabular}
    ...
    \centering
        \begin{tikzpicture}
            ...
            \begin{umlsystem}[x=9, y=0]{UC-3 Visualizzazione dashboard urbanistica}
                ...
                \umlusecase[x=0, y=-7.5, width=100, name=UC-paypark2]{UC-3.10 \\ Visualizzazione pannello \glossterm{Gauge} per dati pagamento parcheggio }

                \umlusecase[x=0, y=-10, width=100, name=UC-paycharge2]{UC-3.11 \\ Visualizzazione pannello \glossterm{Gauge} per dati pagamento colonnine di ricarica }
            \end{umlsystem}
...
\begin{longtable}{|>{\centering\arraybackslash}p{1.2cm}|>{\centering\arraybackslash}p{2cm}|>{\centering\arraybackslash}p{8.5cm}|>{\centering\arraybackslash}p{3cm}|}
    ...
    \endlastfoot
            ...
            RQ-7 & Obbligatorio & Gli eventuali problemi aperti e le soluzioni da esplorare devono essere adeguatamente riportati in un apposito documento. & \glossterm{Capitolato} \\ \hline
\end{longtable}
\newpage
