% changelog: "1.0.0, 2024-08-15, Pietro Busato, Approvazione per PB."
...
\begin{table}[ht!]	
	...
	\begin{tabular}{p{1.2cm} p{2cm} p{5cm} p{3cm} p{3cm}}
		...
		\midrule
		1.0.0 & 2024-08-15 & Approvazione per \textbf{PB}. & & Pietro Busato \\
		0.0.0 & 2024-08-14 & Prima stesura del verbale. & Linda Barbiero & Oscar Konieczny \\
		\bottomrule
...
\signatureline{Padova, 2024-08-14}
\end{document}
