% changelog: "1.0.0, 2024-08-02, Fix per approvazione per PB"
...
\begin{table}[ht!]	
	...
	\begin{tabular}{p{1.2cm} p{2cm} p{5cm} p{3cm} p{3cm}}
		...
		\midrule
  				1.0.0 & 2024-08-02 & \textbf{Approvazione per PB} & & \\\\
				0.0.1 & 2024-07-31 & Stesura verbale. & Linda Barbiero & Oscar Konieczny, Pietro Busato 
 			\\ % spazio tra le righe
		\bottomrule
	\end{tabular}
...
L'incontro è iniziato con la presentazione da parte del gruppo dell'avanzamento ottenuto durante lo Sprint appena concluso. In primis è stato mostrato il funzionamento del sistema di stream processing tramite Apache Flink implementato con linguaggio Java; nonostante le problematiche di sviluppo riscontrate durante lo svolgimento dello Sprint, i consigli tempestivi della proponente sotto richiesta del gruppo sulla risoluzione degli stessi ha garantito l'implementazione seguendo la scadenza concordata.\\
