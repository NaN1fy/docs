% changelog: "1.0.0, Pietro Busato, Approvazione per PB"
...
% -- TITOLO INTESTAZIONE -- %
\newcommand{\customtitle}{VERBALE INTERNO DEL 2024-07-30} % o ESTERNO
...
\begin{titlepage}
	...
	\begin{center}
		\begin{flushright}
			{\fontsize{30pt}{52pt}\selectfont \textbf{Verbale Interno Del\\2024-07-30\\}} % o ESTERNO
		\end{flushright}
		\vspace{3cm}
	\end{center}
	\vspace{8.5 cm}
...
\begin{table}[ht!]	
	...
	\begin{tabular}{p{1.2cm} p{2cm} p{5cm} p{3cm} p{3cm}}
		...
		\midrule
			...
			0.0.0 & 2024-08-12 & Stesura del verbale. & Guglielmo Barison & Pietro Busato, Davide Donanzan
 			\\ % spazio tra le righe
...
\begin{itemize}
\setlength\itemsep{0em}
    \item Definizione delle rifiniture da apportare in vista del collaudo in data 2024-08-09.
\end{itemize}
\subsection{Sintesi dell'incontro}
La riunione è iniziata definendo le rifiniture necessarie al completamento del prodotto. Attraverso un analisi approfondita dello stato di completamento del software, ad ogni membro del team è stato asseganto un compito da portare a termine entro la data prefissata per il collaudo. \\
Gli ambiti di miglioramento individuati riguardano la sistemazione grafica delle dashboard e del funzionamento delle variabili, la personalizzazione dell'interfaccia di Grafana e il completamento della documentazione.
Successivamente è stata discussa la possibilità di anticipare la presentazione alla revisione PB considerando le tempistiche a nostra disposizione.
Infine è stata ideata la presentazione da esporre all'azienda distribuendone una parte ad ogni membro.
\subsection{Decisioni prese}
\begin{itemize}
\setlength\itemsep{0em}
    \item Un membro contatterà i professori per informarsi sulle tempistiche riguardanti le revisioni PB;
    \item Assegnazione delle parti di presentazione per ogni membro.
\end{itemize}
\newpage
...
\begin{table}[ht!]
	...
	\begin{tabular}{p{7cm}cp{7cm}}
        ...
        \href{https://github.com/NaN1fy/docs/issues/}{\underline{Stesura motivazione scelta Apache Flink per stream processing}} & 93 & Pietro Busato, Davide Donanzan, Guglielmo Barison \\\\
		\bottomrule
	\end{tabular}
	\begin{tablenotes}
		\vspace{1em}
