% changelog: "0.0.1, 2024-08-05, Linda Barbiero, Stesura verbale"
...
\begin{table}[ht!]	
	...
	\begin{tabular}{p{1.2cm} p{2cm} p{5cm} p{3cm} p{3cm}}
		...
		\midrule
			0.0.1 & 2024-08-05 & Stesura verbale. & Linda Barbiero & \\
 			\\ % spazio tra le righe
...
Come d'accordo con l'azienda, il team si occuperà di ultimare l'implementazione del sistema di steam processing tramite Apache Flink, di sistemare le dashboard relative ai casi d'uso non implementati e alla personalizzazione dell'interfaccia grafica di Grafana.\\
