% changelog: "0.0.0, 2024-06-07, Guglielmo Barison, Stestura verbale"
...
\begin{itemize}
	\setlength\itemsep{0em}
  \item Discussione post SAL e ``Diario di Bordo" avvenuto in data 2024-06-07 con l’azienda
      SyncLab;
    \item Retrospettiva del quinto Sprint concluso e consuntivo ore;
    \item Pianificazione del sesto Sprint, suddivisione dei ruoli e calcolo preventivo ore.
\end{itemize}
\subsection{Sintesi dell'incontro}
La riunione si è tenuta dopo il SAL e il ``Diario di bordo" svoltisi nel pomeriggio, con la
consapevolezza del prossimo incontro di SAL fissato per il 21 giugno 2024. L'incontro è iniziato
valutando le considerazioni della Proponente. Il gruppo ha quindi ufficialmente concluso lo Sprint
precedente calcolandone il consuntivo. A differenza del precedente, questo Sprint durerà due
settimane, anche in vista del colloquio con il Prof. Riccardo Cardin prefissato per la settimana successiva. L'azienda proponente lascia comunque la possibilità di tenere un incontro di carattere più leggero per verificare lo stato dei lavori.
Dopo il colloquio con la Proponente, si è deciso che lo Sprint attuale avrà due obiettivi
principali: l'introduzione di sensori aggiuntivi per ampliare la gamma di metriche monitorabili e
l'analisi dei casi in cui adottare lo stream processing (rimandando a Sprint successivi la sua
implementazione, concentrandosi sull'approfondimento delle tecnologie da utilizzare). 
\\Inoltre, si continua con la stesura del \textit{Piano di Progetto} seguendo il consueto flusso di lavoro. Infine, la
riunione si è conclusa con lo Sprint planning e la stima delle ore per il successivo.
