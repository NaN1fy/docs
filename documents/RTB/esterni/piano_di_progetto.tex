% changelog: "0.9.0, 2024-05-03, Stesura consuntivo terzo periodo, Guglielmo Barison"
...
\begin{tikzpicture}[remember picture, overlay]
	...
	\begin{minipage}[t]{0.47\textwidth}\raggedleft
		{\large{\textsc{Redattori}}
			...
			{\large{\textsc{Veronica Tecchiatti}}}
...
\hypersetup{hidelinks}
	...
	\begin{tabular}{p{1.2cm} p{2cm} p{6cm} p{3cm} p{2cm}}
		...
		\midrule 
        0.9.0 & 2024-05-16 & Stesura consuntivo terzo periodo e correzioni minori. & Guglielmo
        Barison & Redattore \\\\
