% changelog: "1.2.0, 2024-06-23, Davide Donanzan, Consuntivo sesto sprint"
...
\hypersetup{hidelinks}
	...
	\begin{tabular}{p{1.2cm} p{2cm} p{6cm} p{3cm} p{2cm}}
		...
		\midrule 
		1.2.0 & 2024-06-23 & Stesura \glossterm{consuntivo} sesto periodo. & Davide Donanzan & Redattore \\\\
		1.1.0 & 2024-06-11 & Stesura \glossterm{preventivo} sesto periodo. & Davide Donanzan & Redattore \\\\
...
\begin{table}[ht!]
	...
	\begin{tabular}{p{3cm} p{1.4cm} p{1.6cm} p{1.7cm} p{1.4cm} p{1.4cm} p{1.5cm} p{2cm}}
        ...
        Oscar Konieczny    & 3 \textcolor{teal}{(-1)} & - & 3 \textcolor{teal}{(-1)} & 3
        \textcolor{red}{(+3)} & 3,5 \textcolor{red}{(+0,5)} & 4 \textcolor{red}{(+1)} & 16,5 \textcolor{red}{(+2,5)}\\
...
\begin{table}[ht!]
	...
	\begin{tabular}{p{3cm} p{1.4cm} p{1.6cm} p{1.5cm} p{1.5cm} p{1.5cm} p{1.5cm} p{2cm}}
        ...
        Gugliemo Barison   & 1    & 5   & 14,5 & 7   & 9,5  & 13  & 49 \\
        Pietro Busato      & -1   & 2,5 & 14,5 & 3,5 & 12,5 & 13  & 46 \\
        Davide Donanzan    & 4    & 8   & 12   & 2   & 9    & 10  & 45 \\
        Oscar Konieczny    & -2,5 & 7   & 15   & 4   & 14,5 & 10  & 48 \\
        Veronica Tecchiati & 1,5  & 4,5 & 17   & 0   & 18   & 9   & 50 \\
        \midrule
        \textbf{Totale (ruolo)} & 5 & 32 & 87 & 22,5 & 75,5 & 63,5 & 285,5 \\
		\bottomrule
	\end{tabular}
...
\begin{table}[ht!]
	...
	\begin{tabular}{p{3cm} p{1.4cm} p{1.6cm} p{1.7cm} p{1.4cm} p{1.4cm} p{1.5cm} p{2cm}}
		...
		& \textbf{AM} & \textbf{RE} & \textbf{PT} & \textbf{AN} & \textbf{PR} & \textbf{VE}\\
		\midrule
        Linda Barbiero          & -     & -     & 4 \textcolor{red}{(+1)}  & 6 \textcolor{teal}{(-1)} & 4                        & 1                        & 15 \\
        Guglielmo Barison       & -     & -     & 4                        & 6                        & 1                        & 3                        & 14 \\
        Pietro Busato           & -     & -     & 4 \textcolor{teal}{(-1)} & 2 \textcolor{teal}{(-1)} & 4 \textcolor{teal}{(-1)} & 3 \textcolor{teal}{(-1)} & 13 \textcolor{teal}{(-4)} \\
        Davide Donanzan         & -     & 6     & 4                        & -                        & -                        & 2                        & 12 \\
        Oscar Konieczny         & -     & -     & 4                        & 3                        & 2                        & 2                        & 11 \\
        Veronica Tecchiati      & -     & -     & 4 \textcolor{teal}{(-2)} & -                        & 5 \textcolor{teal}{(-3)} & 2                        & 11 \textcolor{teal}{(-5)}\\
        \bottomrule
...
\begin{table}[ht!]
	...
	\begin{tabular}{p{3cm} p{1.4cm} p{1.6cm} p{1.5cm} p{1.5cm} p{1.5cm} p{1.5cm} p{2cm}}
        ...
        Pietro Busato      & -1   & 2,5 & 11,5 & 2,5 & 9,5  & 12  & 37 \\
        Davide Donanzan    & 4    & 2   & 8    & 2   & 9    & 8   & 33 \\
        Oscar Konieczny    & -2,5 & 7   & 11   & 1   & 12,5 & 8   & 37 \\
        Veronica Tecchiati & 1,5  & 4,5 & 15   & 0   & 16   & 7   & 44 \\
        \midrule
        \textbf{Totale (ruolo)} & 5 & 26 & 65 & 7,5 & 63,5 & 51,5 & 218,5 \\
		\bottomrule
	\end{tabular}
...
\begin{table}[ht!]
    ...
    \begin{tabular}{p{4cm} p{1.8cm} p{2.2cm}}
        ...
        Amministratore & -                         & -   \\
        Responsabile   & 6                         & 120 \\
        Progettista    & 24 \textcolor{teal}{(-2)} & 600 \textcolor{teal}{(-50)} \\
        Analista       & 17 \textcolor{teal}{(-2)} & 425 \textcolor{teal}{(-50)} \\
        Programmatore  & 16 \textcolor{teal}{(-4)} & 240 \textcolor{teal}{(-60)} \\
        Verificatore   & 13 \textcolor{teal}{(-1)} & 195 \textcolor{teal}{(-15)} \\
        \bottomrule
