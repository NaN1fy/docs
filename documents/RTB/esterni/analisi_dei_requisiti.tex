    ...
    \centering
        \begin{tikzpicture}
            ...
            \begin{umlsystem}[x=6, y=0]{SyncCity}
                ...
                \umlusecase[x=0, y=-3, width=80, name=UC-4]{UC-4 \\ Visualizzazione errore nessun dato}
            \end{umlsystem}
    ...
    \centering
        \begin{tikzpicture}
            ...
            \begin{umlsystem}[x=6, y=0]{UC-1 Visualizzazione dashboard sensori}
                \umlusecase[x=0, y=0, width=80, name=UC-position]{UC-1.1 \\ Visualizzazione posizione sensori su mappa}
            \end{umlsystem}
...
\begin{figure}[ht!]
    \centering
        \begin{tikzpicture}
            ...
            \begin{umlsystem}[x=7, y=0]{UC-2 Visualizzazione dashboard ambientale}
                \umlusecase[x=0, y=0, width=80, name=UC-temp]{UC-2.1 \\ Visualizzazione pannello time series per temperatura}

                \umlusecase[x=0, y=-3, width=80, name=UC-humid]{UC-2.2 \\ Visualizzazione pannello time series per umidità}

                \umlusecase[x=0, y=-6, width=80, name=UC-temp-perc]{UC-2.3 \\ Visualizzazione pannello time series per temperatura percepita}

                \umlusecase[x=0, y=-9.2, width=80, name=UC-temp-avg]{UC-2.4 \\ Visualizzazione pannello Gauge per temperatura media}
            \end{umlsystem}
...
\begin{figure}[ht!]
    \centering
        \begin{tikzpicture}
            \umlactor[x=0, y=-5, inner xsep=3em, inner ysep=3em]{Amministratore pubblico}
            \begin{umlsystem}[x=7, y=0]{UC-3 Visualizzazione dashboard urbanistica}
                \umlusecase[x=0, y=0, width=80, name=UC-pay]{UC-3.1 \\ Visualizzazione pannello alert list per notifiche di pagamento}

                \umlusecase[x=0, y=-3, width=80, name=UC-park]{UC-3.2 \\ Visualizzazione pannello status history per parcheggi}

                \umlusecase[x=0, y=-6, width=80, name=UC-boh]{UC-3.3 \\ ...}

                \umlusecase[x=0, y=-9.2, width=80, name=UC-boh2]{UC-3.4 \\ ...}
            \end{umlsystem}
                \umlassoc{Amministratore pubblico}{UC-pay}
                \umlassoc{Amministratore pubblico}{UC-park}
                \umlassoc{Amministratore pubblico}{UC-boh}
                \umlassoc{Amministratore pubblico}{UC-boh2}
        \end{tikzpicture}
...
\begin{figure}[ht!]
    \centering
        \begin{tikzpicture}
            \umlactor[x=0, y=0]{Amministratore pubblico}
            \begin{umlsystem}[x=6, y=0]{SyncCity}
                \umlusecase[x=0, y=0, width=80, name=UC-5]{UC-5 \\ Applicazione filtri}
            \end{umlsystem}
...
\begin{figure}[ht!]
    \centering
        \begin{tikzpicture}
            ...
            \begin{umlsystem}[x=7, y=0]{UC-5 Applicazione filtri}
                \umlusecase[x=0, y=0, width=80, name=UC-series]{UC-5.1 \\ Filtro sotto-insieme di sensori su grafici time series}

                \umlusecase[x=0, y=-3, width=80, name=UC-time]{UC-5.2 \\ Filtro per intervallo temporale}
...
\begin{figure}[ht!]
    \centering
        \begin{tikzpicture}
            \umlactor[x=0, y=0]{Amministratore pubblico}
            \begin{umlsystem}[x=6, y=0]{SyncCity}
                \umlusecase[x=0, y=0, width=80, name=UC-6]{UC-6 \\ Modifica layout pannelli}
            \end{umlsystem}
...
\begin{figure}[ht!]
    \centering
        \begin{tikzpicture}
            ...
            \begin{umlsystem}[x=6, y=0]{SyncCity}
                \umlusecase[x=0, y=0, width=80, name=UC-7]{UC-7 \\ Inserimento dati sensore}
            \end{umlsystem}
                \umlassoc{Sensore}{UC-7}
        \end{tikzpicture}
...
\begin{figure}[ht!]
    \centering
        \begin{tikzpicture}
            \umlactor[x=0, y=-5, inner xsep=1em]{Sensore}
            \begin{umlsystem}[x=7, y=0]{UC-7 Inserimento dati}
                \umlusecase[x=0, y=0, width=80, name=UC-temp]{UC-7.1 \\ Inserimento dati temperatura}

                \umlusecase[x=0, y=-3, width=80, name=UC-humid]{UC-7.2 \\ Inserimento dati umidità}

                \umlusecase[x=0, y=-6, width=80, name=UC-park]{UC-7.3 \\ Inserimento dati parcheggio}

                \umlusecase[x=0, y=-9.2, width=80, name=UC-pay]{UC-7.4 \\ Inserimento dati pagamenti parcheggio}
            \end{umlsystem}
                \umlassoc{Sensore}{UC-temp}
                \umlassoc{Sensore}{UC-humid}
                \umlassoc{Sensore}{UC-park}
                \umlassoc{Sensore}{UC-pay}
        \end{tikzpicture}
    \caption{Sottocasi UC-7: Inserimento dati}
    \label{fig:Sottocasi UC-7: Inserimento dati}
\end{figure}
...
\begin{longtable}{p{1.2cm} p{2cm} p{8cm} p{3cm}}
	...
	\textbf{Codice} & \textbf{Importanza} & \textbf{Descrizione} & \textbf{Fonti}\\
		\midrule
            ...
            %RF-2 & Obbligatorio & L'utente deve poter visualizzare la posizione geografica dei sensori su una mappa & \glossterm{Capitolato} \\
