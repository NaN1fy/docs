% changelog: "0.7.2, 2024-06-03, Linda Barbiero, Verifica completa con piccole modifiche alle descrizioni dei casi d'uso"
...
\begin{itemize}
    ...
    \item \textbf{Precondizioni: }l'amministratore pubblico ha selezionato la visualizzazione
        relativa al dominio ambientale;
    \item \textbf{Postcondizioni:} l'amministratore pubblico visualizza un pannello con un grafico che mostra la media della temperatura, in gradi Celsius (°C), in formato di diagramma di Gauge considerando l'ultimo valore registrato per ogni sensore attivo all'interno della dashbaord.
    \item \textbf{Scenario principale}:
    \begin{enumerate}
    \item L’amministratore pubblico accede alla piattaforma di visualizzazione;
    \item L’amministratore pubblico seleziona la visualizzazione della dashboard relativa al dominio
...
\begin{itemize}
    ...
    \item \textbf{Precondizioni: }l'amministratore pubblico ha selezionato la visualizzazione
        relativa al dominio ambientale;
    \item \textbf{Postcondizioni:} l'amministratore pubblico visualizza un pannello con un grafico che mostra la media dell'umidità, in gradi Celsius (°C), in formato di diagramma di Gauge considerando l'ultimo valore registrato per ogni sensore attivo all'interno della dashbaord.
    \item \textbf{Scenario principale}:
    \begin{enumerate}
    \item L’amministratore pubblico accede alla piattaforma di visualizzazione;
    \item L’amministratore pubblico seleziona la visualizzazione della dashboard relativa al dominio
...
\begin{itemize}
    ...
    \item \textbf{Precondizioni:} l'amministratore pubblico ha selezionato la visualizzazione
        relativa al dominio ambientale;
    \item \textbf{Postcondizioni:} l'amministratore pubblico visualizza un pannello con un grafico che mostra l'intensità delle precipitazioni attuale, in gradi millimetri orari (mm/h), in formato di diagramma di Gauge considerando l'ultimo valore registrato per ogni sensore attivo all'interno della dashbaord.
    \item \textbf{Scenario principale}:
    \begin{enumerate}
    \item L'amministratore pubblico accede alla piattaforma di visualizzazione;
    \item L'amministratore pubblico seleziona la visualizzazione della dashboard relativa al dominio
...
\begin{itemize}
    ...
    \item \textbf{Precondizioni:} l'amministratore pubblico ha selezionato la visualizzazione
        relativa al dominio ambientale;
    \item \textbf{Postcondizioni:} l'amministratore pubblico visualizza un pannello con un grafico che mostra l'inquinamento dell'aria attuale, in microgrammi per metro cubo ($\mu g / m^3$), in formato di diagramma di Gauge considerando l'ultimo valore registrato per ogni sensore attivo all'interno della dashbaord.
    \item \textbf{Scenario principale}:
    \begin{enumerate}
    \item L'amministratore pubblico accede alla piattaforma di visualizzazione;
    \item L'amministratore pubblico seleziona la visualizzazione della dashboard relativa al dominio
...
\begin{itemize}
    ...
    \item \textbf{Precondizioni:} l'amministratore pubblico ha selezionato la visualizzazione
        relativa al dominio ambientale;
    \item \textbf{Postcondizioni:} l'amministratore pubblico visualizza un pannello con un grafico che mostra il livello dell'acqua attuale, in percentuale, in formato di diagramma di Gauge considerando l'ultimo valore registrato per ogni sensore attivo all'interno della dashboard.
    \item \textbf{Scenario principale}:
    \begin{enumerate}
    \item L'amministratore pubblico accede alla piattaforma di visualizzazione;
    \item L'amministratore pubblico seleziona la visualizzazione della dashboard relativa al dominio
...
\begin{longtable}{|>{\centering\arraybackslash}p{1.2cm}|>{\centering\arraybackslash}p{2cm}|>{\centering\arraybackslash}p{8.5cm}|>{\centering\arraybackslash}p{3cm}|}
 ...
 \endlastfoot
            ...
            RF-23 & Desiderabile & L'utente deve poter visualizzare un \glossterm{widget} che mostra la temperatura media in formato diagramma di Gauge considerando l'ultimo valore registrato per ogni sensore attivo. & UC-2.4 \\ \hline
            RF-24 & Desiderabile & L'utente deve poter visualizzare un \glossterm{widget} che mostra l'umidità media in formato diagramma di Gauge considerando l'ultimo valore registrato per ogni sensore attivo. & UC-2.5 \\ \hline
            RF-25 & Desiderabile & L'utente deve poter visualizzare un \glossterm{widget} che mostra la temperatura percepita media in formato diagramma di Gauge considerando l'ultima coppia di valori di temperatura e umidità registrati per ogni rispettivo sensore attivo. & UC-2.6 \\ \hline
            ...
            RF-31 & Desiderabile & L'utente deve poter visualizzare un \glossterm{widget} che mostra l'intensità delle precipitazioni attuale in formato diagramma di Gauge considerando l'ultimo valore registrato per ogni sensore attivo. & UC-2.12 \\ \hline
            RF-32 & Desiderabile & L'utente deve poter visualizzare un \glossterm{widget} che mostra l'inquinamento dell'aria attuale in formato diagramma di Gauge considerando l'ultimo valore registrato per ogni sensore attivo. & UC-2.13 \\ \hline
            RF-33 & Desiderabile & L'utente deve poter visualizzare un \glossterm{widget} che mostra il livello dell'acqua attuale in formato diagramma di Gauge considerando l'ultimo valore registrato per ogni sensore attivo. & UC-2.14 \\ \hline
