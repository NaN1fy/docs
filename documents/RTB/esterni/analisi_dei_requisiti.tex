% changelog: "0.7.0, 2024-05-31, Davide Donanzan, Stesura ulteriori casi d'uso"
...
\begin{itemize}
    ...
    \item \textbf{Precondizioni: }l’amministratore pubblico ha selezionato la visualizzazione
        relativa al dominio ambientale;
    \item \textbf{Postcondizioni:} L’amministratore pubblico visualizza un pannello con un grafico che mostra la media dell'umidità, in gradi Celsius (°C), in formato di diagramma di Gauge considerando tutti i sensori attivi nell'intervallo di tempo all'interno della dashbaord.
    \item \textbf{Scenario principale}:
    \begin{enumerate}
    \item L’amministratore pubblico accede alla piattaforma di visualizzazione;
    \item L’amministratore pubblico seleziona la visualizzazione della dashboard relativa al dominio
...
\begin{itemize}
    ...
    \item \textbf{Precondizioni: }l’amministratore pubblico ha selezionato la visualizzazione
        relativa al dominio ambientale;
    \item \textbf{Postcondizioni:} L’amministratore pubblico visualizza un pannello con un grafico che mostra la media della temperatura percepita, in gradi Celsius (°C), in formato di diagramma di Gauge considerando tutti i sensori attivi nell'intervallo di tempo all'interno della dashbaord.
    \item \textbf{Scenario principale}:
    \begin{enumerate}
    \item L’amministratore pubblico accede alla piattaforma di visualizzazione;
    \item L’amministratore pubblico seleziona la visualizzazione della dashboard relativa al dominio
...
\end{itemize}
\subsubsection*{UC-2.12: Visualizzazione pannello Gauge per intensità di precipitazioni attuale}
\addcontentsline{toc}{subsubsection}{\protect\numberline{}UC-2.12: Visualizzazione pannello Gauge per intensità di precipitazioni attuale}
\begin{itemize}
    \item \textbf{Attore principale:} amministratore pubblico;
    \item \textbf{Precondizioni: }l’amministratore pubblico ha selezionato la visualizzazione
        relativa al dominio ambientale;
    \item \textbf{Postcondizioni:} L’amministratore pubblico visualizza un pannello con un grafico che mostra l'intensità di precipitazioni attuale, in gradi millimetri orari (mm/h), in formato di diagramma di Gauge considerando tutti i sensori attivi nell'intervallo di tempo all'interno della dashbaord.
    \item \textbf{Scenario principale}:
    \begin{enumerate}
    \item L’amministratore pubblico accede alla piattaforma di visualizzazione;
    \item L’amministratore pubblico seleziona la visualizzazione della dashboard relativa al dominio
        ambientale; 
    \item L’amministratore pubblico seleziona la visualizzazione del pannello per l'intensità di precipitazioni attuale.
    \end{enumerate}
\item \textbf{User Story associata:} in qualità di amministratore pubblico, desidero accedere al pannello per monitorare l'intensità di precipitazioni attuale. Questo consente di semplificare la comprensione e la comparazione delle misurazioni.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Precondizioni: }l’amministratore pubblico ha selezionato la visualizzazione
        relativa al dominio ambientale;
    \item \textbf{Postcondizioni:} L’amministratore pubblico visualizza un pannello con un grafico che mostra l'inquinamento dell'aria attuale, in microgrammi per metro cubo ($\mu g / m^3$), in formato di diagramma di Gauge considerando tutti i sensori attivi nell'intervallo di tempo all'interno della dashbaord.
    \item \textbf{Scenario principale}:
    \begin{enumerate}
    \item L’amministratore pubblico accede alla piattaforma di visualizzazione;
    \item L’amministratore pubblico seleziona la visualizzazione della dashboard relativa al dominio
...
\begin{itemize}
    ...
    \item \textbf{Precondizioni: }l’amministratore pubblico ha selezionato la visualizzazione
        relativa al dominio ambientale;
    \item \textbf{Postcondizioni:} L’amministratore pubblico visualizza un pannello con un grafico che mostra il livello dell'acqua attuale, in percentuale, in formato di diagramma di Gauge considerando tutti i sensori attivi nell'intervallo di tempo all'interno della dashbaord.
    \item \textbf{Scenario principale}:
    \begin{enumerate}
    \item L’amministratore pubblico accede alla piattaforma di visualizzazione;
    \item L’amministratore pubblico seleziona la visualizzazione della dashboard relativa al dominio
    ...
    \centering
        \begin{tikzpicture}
            ...
            \begin{umlsystem}[x=9, y=0]{UC-2 Visualizzazione dashboard ambientale}
                ...
                \umlusecase[x=0, y=-10, width=100, name=UC-rain-act]{UC-2.12 \\ Visualizzazione pannello Gauge per intensità di precipitazioni attuale}
...
\begin{longtable}{|>{\centering\arraybackslash}p{1.2cm}|>{\centering\arraybackslash}p{2cm}|>{\centering\arraybackslash}p{8.5cm}|>{\centering\arraybackslash}p{3cm}|}
 ...
 \endlastfoot
            ...
            RF-23 & Desiderabile & L'utente deve poter visualizzare un \glossterm{widget} che mostra la temperatura media in formato diagramma di Gauge considerando tutti i sensori attivi nell'intervallo di tempo. & UC-2.4 \\ \hline
            RF-24 & Desiderabile & L'utente deve poter visualizzare un \glossterm{widget} che mostra l'umidità media in formato diagramma di Gauge considerando tutti i sensori attivi nell'intervallo di tempo. & UC-2.5 \\ \hline
            RF-25 & Desiderabile & L'utente deve poter visualizzare un \glossterm{widget} che mostra la temperatura percepita media in formato diagramma di Gauge considerando tutti i sensori attivi nell'intervallo di tempo. & UC-2.6 \\ \hline
            RF-26 & Desiderabile & L'utente deve poter visualizzare un \glossterm{widget} che mostra le statistiche di temperatura in formato diagramma a barre considerando ciascun sensore attivo. & UC-2.7 \\ \hline
            RF-27 & Desiderabile & L'utente deve poter visualizzare un \glossterm{widget} che mostra le statistiche di temperatura percepita in formato diagramma a barre considerando ciascun sensore attivo. & UC-2.8 \\ \hline
            ...
            RF-31 & Desiderabile & L'utente deve poter visualizzare un \glossterm{widget} che mostra l'intensità di precipitazioni attuale in formato diagramma di Gauge considerando tutti i sensori attivi nell'intervallo di tempo. & UC-2.12 \\ \hline
            RF-32 & Desiderabile & L'utente deve poter visualizzare un \glossterm{widget} che mostra l'inquinamento dell'aria attuale in formato diagramma di Gauge considerando tutti i sensori attivi nell'intervallo di tempo. & UC-2.13 \\ \hline
            RF-33 & Desiderabile & L'utente deve poter visualizzare un \glossterm{widget} che mostra il livello dell'acqua attuale in formato diagramma di Gauge considerando tutti i sensori attivi nell'intervallo di tempo. & UC-2.14 \\ \hline
            ...
            RF-73 & Obbligatorio & Il sistema consentire la correlazione di dati provenienti da sensori diversi. & \glossterm{Proponente} \\
		\hline
\end{longtable}
\clearpage
...
\rowcolor{white}
  \caption{Tracciamento fonte - requisito.}
	\label{table:Tracciamento requisito - fonte}
 \endlastfoot
            Capitolato & RF-1, RF-2, RF-3, RF-4, RF-5, RF-6, RF-7, RF-8, RF-9, RF-11, RF-12, RF-13, RF-14, RF-15, RF-18, RQ-3, RQ-5, RQ-6, RQ-7, RV-1, RV-2, RV-3 \\ \hline
