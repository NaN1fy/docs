% changelog: "0.4.0, 2024-05-28, Veronica Tecchiati, Stesura ulteriori casi d'uso e requisiti. Scrittura sezioni 4.5 e 4.6"
...
o guasto elettrico di colonnine HPC, traffico stradale e via dicendo. Il \glossterm{Proponente} richiede la
...
\end{itemize}
\subsubsection*{UC-2.5: Visualizzazione pannello time series per precipitazioni}
\addcontentsline{toc}{subsubsection}{\protect\numberline{}UC-2.5: Visualizzazione pannello time series per precipitazioni}
\begin{itemize}
    \item \textbf{Attore principale:} amministratore pubblico;
    \item \textbf{Precondizioni: }l’amministratore pubblico ha selezionato la visualizzazione
        relativa al dominio ambientale;
...
\end{itemize}
\subsubsection*{UC-2.6: Visualizzazione pannello time series per inquinamento dell'aria}
\addcontentsline{toc}{subsubsection}{\protect\numberline{}UC-2.6: Visualizzazione pannello time series per inquinamento dell'aria}
\begin{itemize}
    \item \textbf{Attore principale:} amministratore pubblico;
    \item \textbf{Precondizioni: }l’amministratore pubblico ha selezionato la visualizzazione
        relativa al dominio ambientale;
...
\end{itemize}
\subsubsection*{UC-2.7: Visualizzazione pannello time series per livello di acqua}
\addcontentsline{toc}{subsubsection}{\protect\numberline{}UC-2.7: Visualizzazione pannello time series per livello di acqua}
\begin{itemize}
    \item \textbf{Attore principale:} amministratore pubblico;
    \item \textbf{Precondizioni: }l’amministratore pubblico ha selezionato la visualizzazione
        relativa al dominio ambientale;
    ...
    \centering
        \begin{tikzpicture}
            ...
            \begin{umlsystem}[x=9, y=0]{UC-2 Visualizzazione dashboard ambientale}
                ...
                \umlusecase[x=0, y=-10, width=100, name=UC-rain]{UC-2.5 \\ Visualizzazione pannello time series per precipitazioni}

                \umlusecase[x=0, y=-12.5, width=100, name=UC-pollut]{UC-2.6 \\ Visualizzazione pannello time series per inquinamento dell'aria}

                \umlusecase[x=0, y=-15, width=100, name=UC-water]{UC-2.7 \\ Visualizzazione pannello time series per livello di acqua}
            \end{umlsystem}
...
\begin{itemize}
    ...
    \item \textbf {Specializzazioni:} [UC-3.1], [UC-3.2], [UC-3.3], [UC-3.4], [UC-3.5], [UC-3.6], [UC-3.7];
    \item \textbf{Estensioni:} [UC-5].
\end{itemize}
\begin{figure}[ht!]
    \centering
...
\end{figure}
\subsubsection*{UC-3.1: Visualizzazione pannello mappa interattiva per disponibilità parcheggi}
\addcontentsline{toc}{subsubsection}{\protect\numberline{}UC-3.1: Visualizzazione pannello mappa interattiva per disponibilità parcheggi}
\begin{itemize}
    \item \textbf{Attore principale:} amministratore pubblico;
    \item \textbf{Precondizioni:} l’amministratore pubblico ha selezionato la visualizzazione
        relativa al dominio urbanistico.
    \item \textbf{Postcondizioni:} l'amministratore pubblico visualizza un pannello che mostra lo stato di occupazione dei parcheggi, espresso con valori binari, in formato mappa interattiva;
    \item \textbf{Scenario principale:} 
    \begin{enumerate}
    \item L’amministratore pubblico accede alla piattaforma di visualizzazione;
    \item L’amministratore pubblico seleziona la visualizzazione della dashboard relativa al dominio
        urbanistico;
    \item L’amministratore pubblico seleziona la visualizzazione del pannello mappa interattiva per lo stato di occupazione dei parcheggi.
    \end{enumerate}
...
\end{itemize}
\subsubsection*{UC-3.2: Visualizzazione pannello alert list per notifiche pagamento parcheggi}
\addcontentsline{toc}{subsubsection}{\protect\numberline{}UC-3.2: Visualizzazione pannello alert list per notifiche pagamento parcheggi}
\begin{itemize}
    \item \textbf{Attore principale:} amministratore pubblico;
    \item \textbf{Precondizioni:} l’amministratore pubblico ha selezionato la visualizzazione
        relativa al dominio urbanistico.
    ...
    \item L’amministratore pubblico seleziona la visualizzazione del pannello alert list per le notifiche di pagamento dei parcheggi.
    \end{enumerate}
...
\end{itemize}
\subsubsection*{UC-3.3: Visualizzazione pannello mappa interattiva per guasti elettrici}
\addcontentsline{toc}{subsubsection}{\protect\numberline{}UC-3.3: Visualizzazione pannello mappa interattiva per guasti elettrici}
\begin{itemize}
    \item \textbf{Attore principale:} amministratore pubblico;
    \item \textbf{Precondizioni:} l’amministratore pubblico ha selezionato la visualizzazione
        relativa al dominio urbanistico.
    \item \textbf{Postcondizioni:} l'amministratore pubblico visualizza un pannello che mostra i gusti sulla rete elettrica, espressi mediante valori binari, in formato mappa interattiva;
    \item \textbf{Scenario principale:} 
    \begin{enumerate}
    \item L’amministratore pubblico accede alla piattaforma di visualizzazione;
    \item L’amministratore pubblico seleziona la visualizzazione della dashboard relativa al dominio urbanistico;
    \item L’amministratore pubblico seleziona la visualizzazione del pannello mappa interattiva per i guasti.
    \end{enumerate}
...
\end{itemize}
\subsubsection*{UC-3.5: Visualizzazione pannello mappa interattiva per disponibilità colonnine di ricarica}
\addcontentsline{toc}{subsubsection}{\protect\numberline{}UC-3.5: Visualizzazione pannello mappa interattiva per disponibilità colonnine di ricarica}
\begin{itemize}
    \item \textbf{Attore principale:} amministratore pubblico;
    \item \textbf{Precondizioni:} l’amministratore pubblico ha selezionato la visualizzazione
        relativa al dominio urbanistico.
    \item \textbf{Postcondizioni:} l'amministratore pubblico visualizza un pannello che mostra lo stato di occupazione delle colonnine di ricarica, espresso mediante valori binari, in formato mappa interattiva;
    \item \textbf{Scenario principale:} 
    \begin{enumerate}
    \item L’amministratore pubblico accede alla piattaforma di visualizzazione;
    \item L’amministratore pubblico seleziona la visualizzazione della dashboard relativa al dominio urbanistico;
...
\end{itemize}
\subsubsection*{UC-3.7: Visualizzazione pannello alert list per notifiche pagamento colonnine di ricarica}
\addcontentsline{toc}{subsubsection}{\protect\numberline{}UC-3.2: Visualizzazione pannello alert list per notifiche pagamento colonnine di ricarica}
\begin{itemize}
    \item \textbf{Attore principale:} amministratore pubblico;
    \item \textbf{Precondizioni:} l’amministratore pubblico ha selezionato la visualizzazione
        relativa al dominio urbanistico.
    ...
    \item L’amministratore pubblico accede alla piattaforma di visualizzazione;
    \item L’amministratore pubblico seleziona la visualizzazione della dashboard relativa al dominio urbanistico;
    \item L’amministratore pubblico seleziona la visualizzazione del pannello alert list per le notifiche di pagamento delle colonnine di ricarica.
    \end{enumerate}
    ...
    \centering
        \begin{tikzpicture}
            ...
            \begin{umlsystem}[x=9, y=0]{UC-3 Visualizzazione dashboard urbanistica}
                \umlusecase[x=0, y=0, width=100, name=UC-park]{UC-3.1 \\ Visualizzazione pannello mappa interattiva per disponibilità parcheggi}

                \umlusecase[x=0, y=-2.5, width=100, name=UC-paypark]{UC-3.2 \\ Visualizzazione pannello alert list per notifiche pagamento parcheggi}

                \umlusecase[x=0, y=-5, width=100, name=UC-elec]{UC-3.3 \\ Visualizzazione pannello mappa interattiva per guasti elettrici}

                \umlusecase[x=0, y=-7.5, width=100, name=UC-eco]{UC-3.4 \\ Visualizzazione pannello time series per riempimento isole ecologiche}

                \umlusecase[x=0, y=-10.25, width=100, name=UC-charge]{UC-3.5 \\ Visualizzazione pannello mappa interattiva per disponibilità colonnine di ricarica}

                \umlusecase[x=0, y=-13, width=100, name=UC-cons]{UC-3.6 \\ Visualizzazione pannello time series per consumi colonnine di ricarica}

                \umlusecase[x=0, y=-15.75, width=100, name=UC-paycharge]{UC-3.7 \\ Visualizzazione pannello alert list per notifiche pagamento colonnine di ricarica}
            \end{umlsystem}
...
\begin{longtable}{|>{\centering\arraybackslash}p{1.2cm}|>{\centering\arraybackslash}p{2cm}|>{\centering\arraybackslash}p{8.5cm}|>{\centering\arraybackslash}p{3cm}|}
 ...
 \endlastfoot
            ...
            RF-26 & Obbligatorio & L'utente deve poter visualizzare un \glossterm{widget} che mostra una mappa interattiva che descrive lo stato di occupazione dei parcheggi. & UC-3.1 \\ \hline
            ...
            RF-28 & Obbligatorio & L'utente deve poter visualizzare un \glossterm{widget} che mostra una mappa interattiva che descrive i guasti alla fornitura elettrica. & UC-3.3 \\ \hline
            ...
            RF-30 & Obbligatorio & L'utente deve poter visualizzare un \glossterm{widget} che mostra una mappa interattiva che descrive la disponibilità colonnine di ricarica. & UC-3.5 \\ \hline
...
\begin{longtable}{|>{\centering\arraybackslash}p{1.2cm}|>{\centering\arraybackslash}p{2cm}|>{\centering\arraybackslash}p{8.5cm}|>{\centering\arraybackslash}p{3cm}|}
    ...
    \endlastfoot
            RQ-1 & Obbligatorio & Devono essere rispettati i vincoli e le metriche descritti nel documento \textit{Piano di Qualifica v1.0.0}. & Norme di Progetto \\ \hline
            ...
            RQ-4 & Obbligatorio & La \glossterm{\glossterm{Proponente}} deve essere in grado di accedere alla \glossterm{repository} GitHub del prodotto ``SyncCity". & \glossterm{Proponente} \\ \hline
...
\begin{longtable}{|>{\centering\arraybackslash}p{1.2cm}|>{\centering\arraybackslash}p{2cm}|>{\centering\arraybackslash}p{8.5cm}|>{\centering\arraybackslash}p{3cm}|}
    ...
    \endlastfoot
            RV-1 & Obbligatorio & La persistenza dei dati deve essere realizzata grazie ad un database OLAP colonnare come ClickHouse. & \glossterm{Capitolato} \\ \hline
            RV-2 & Obbligatorio & Lo stream di dati deve essere gestito mediante un broker come Apache Kafka. & \glossterm{Capitolato} \\ \hline
            ...
            RV-5 & Obbligatorio & I dati generati dal simulatore devono essere in formato JSON. & Norme di Progetto \\ \hline
\end{longtable}
...
\begin{longtable}{|>{\centering\arraybackslash}p{4cm}|>{\centering\arraybackslash}p{4cm}|}
 ...
 \endlastfoot
            ...
            RQ-1 & Norme di Progetto \\ \hline
            RQ-2 & Norme di Progetto \\ \hline
