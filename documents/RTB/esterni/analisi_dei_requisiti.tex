...
\end{itemize}
\subsubsection*{UC-3.2: Visualizzazione pannello log per notifiche pagamento parcheggi}
\addcontentsline{toc}{subsubsection}{\protect\numberline{}UC-3.2: Visualizzazione pannello log per notifiche pagamento parcheggi}
\begin{itemize}
    \item \textbf{Attore principale:} amministratore pubblico;
    \item \textbf{Precondizioni:} l’amministratore pubblico ha selezionato la visualizzazione
        relativa al dominio urbanistico.
    ...
    \item L’amministratore pubblico seleziona la visualizzazione del pannello log per le notifiche di pagamento dei parcheggi.
    \end{enumerate}
...
\begin{itemize}
    ...
    \item \textbf{Postcondizioni:} l'amministratore pubblico visualizza un pannello che mostra i
        gusti sulla rete elettrica in formato tabellare;
    \item \textbf{Scenario principale:} 
    \begin{enumerate}
    \item L’amministratore pubblico accede alla piattaforma di visualizzazione;
    \item L’amministratore pubblico seleziona la visualizzazione della dashboard relativa al dominio urbanistico;
...
\end{itemize}
\subsubsection*{UC-3.7: Visualizzazione pannello log per notifiche pagamento colonnine di ricarica}
\addcontentsline{toc}{subsubsection}{\protect\numberline{}UC-3.2: Visualizzazione pannello log per notifiche pagamento colonnine di ricarica}
\begin{itemize}
    \item \textbf{Attore principale:} amministratore pubblico;
    \item \textbf{Precondizioni:} l’amministratore pubblico ha selezionato la visualizzazione
        relativa al dominio urbanistico.
    ...
    \item L’amministratore pubblico accede alla piattaforma di visualizzazione;
    \item L’amministratore pubblico seleziona la visualizzazione della dashboard relativa al dominio urbanistico;
    \item L’amministratore pubblico seleziona la visualizzazione del pannello log per le notifiche di pagamento delle colonnine di ricarica.
    \end{enumerate}
    ...
    \centering
        \begin{tikzpicture}
            ...
            \begin{umlsystem}[x=9, y=0]{UC-3 Visualizzazione dashboard urbanistica}
                ...
                pannello log per notifiche pagamento parcheggi}
                ...
                \umlusecase[x=0, y=-10.25, width=100, name=UC-charge]{UC-3.5 \\ Visualizzazione
                pannello tabellare per disponibilità colonnine di ricarica}

                \umlusecase[x=0, y=-13, width=100, name=UC-cons]{UC-3.6 \\ Visualizzazione pannello time series per consumi colonnine di ricarica}

                \umlusecase[x=0, y=-15.75, width=100, name=UC-paycharge]{UC-3.7 \\ Visualizzazione
                pannello log per notifiche pagamento colonnine di ricarica}
                \umlusecase[x=0, y=-18, width=100, name=UC-paypark2]{UC-3.8 \\ Visualizzazione pannello bar gauge per dati pagamento parcheggio }
            \end{umlsystem}
