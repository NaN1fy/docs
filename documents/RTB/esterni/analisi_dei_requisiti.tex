...
\addcontentsline{toc}{subsubsection}{\protect\numberline{}UC-2.12: Visualizzazione pannello Gauge per intensità attuale delle precipitazioni}
\begin{itemize}
    \item \textbf{Attore principale:} amministratore pubblico;
    \item \textbf{Precondizioni:} l'amministratore pubblico ha selezionato la visualizzazione
        relativa al dominio ambientale;
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{}UC-2.13: Visualizzazione pannello Gauge per inquinamento attuale dell'aria}
\begin{itemize}
    \item \textbf{Attore principale:} amministratore pubblico;
    \item \textbf{Precondizioni:} l'amministratore pubblico ha selezionato la visualizzazione
        relativa al dominio ambientale;
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{}UC-2.14: Visualizzazione pannello Gauge per livello attuale dell'acqua}
\begin{itemize}
    \item \textbf{Attore principale:} amministratore pubblico;
    \item \textbf{Precondizioni:} l'amministratore pubblico ha selezionato la visualizzazione
        relativa al dominio ambientale;
    ...
    \centering
        \begin{tikzpicture}
            ...
            \begin{umlsystem}[x=9, y=0]{UC-2 Visualizzazione dashboard ambientale}
                ...
                \umlusecase[x=0, y=-10, width=100, name=UC-rain-act]{UC-2.12 \\ Visualizzazione pannello Gauge per intensità attuale delle precipitazioni}

                \umlusecase[x=0, y=-12.5, width=100, name=UC-pollut-act]{UC-2.13 \\ Visualizzazione pannello Gauge per inquinamento attuale dell'aria}

                \umlusecase[x=0, y=-15, width=100, name=UC-water-act]{UC-2.14 \\ Visualizzazione pannello Gauge per livello attuale dell'acqua}
            \end{umlsystem}
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{}UC-3.10: Visualizzazione pannello Gauge per dati pagamento parcheggio}
\begin{itemize}
    \item \textbf{Attore principale:} amministratore pubblico;
    \item \textbf{Precondizioni:} l’amministratore pubblico ha selezionato la visualizzazione
        relativa al dominio urbanistico.
...
\addcontentsline{toc}{subsubsection}{\protect\numberline{}UC-3.11: Visualizzazione pannello Gauge per dati pagamento di colonnine di ricarica}
\begin{itemize}
    \item \textbf{Attore principale:} amministratore pubblico;
    \item \textbf{Precondizioni:} l’amministratore pubblico ha selezionato la visualizzazione
        relativa al dominio urbanistico.
    ...
    \centering
        \begin{tikzpicture}
            ...
            \begin{umlsystem}[x=9, y=0]{UC-3 Visualizzazione dashboard urbanistica}
                ...
                \umlusecase[x=0, y=-7.5, width=100, name=UC-paypark2]{UC-3.10 \\ Visualizzazione pannello Gauge per dati pagamento parcheggio }

                \umlusecase[x=0, y=-10, width=100, name=UC-paycharge2]{UC-3.11 \\ Visualizzazione pannello Gauge per dati pagamento colonnine di ricarica }
            \end{umlsystem}
