...
\begin{itemize}
	...
	\item \textbf{Test di integrazione:} si verifica il corretto funzionamento di più unità che cooperano per svolgere uno specifico compito (tali unità devono certamente aver superato i loro \glossterm{test} di unità precedentemente);
...
\end{itemize}
Ogni \glossterm{test} ha uno \textbf{Stato}, che puo essere:
\begin{itemize}
...
\end{itemize}
\clearpage
\subsection{Test di unità}\label{sec:test unita}
...
\begin{longtable}{|>{\centering}p{2cm}|>{\RaggedRight}m{12cm}|>{\centering\arraybackslash}p{2cm}|}
    ...
    TU-21 & Verificare che la funzione \verb|\glossterm{JSON}fy| funzioni correttamente. & V \\
    \hline

\end{longtable}
\clearpage
\subsection{Test di integrazione}\label{sec:test integrazione}
\renewcommand{\arraystretch}{2.5}
\rowcolors{2}{gray!20}{white}
\begin{longtable}{|>{\centering}p{2cm}|>{\RaggedRight}m{12cm}|>{\centering\arraybackslash}p{2cm}|}
    \hline
...
\end{longtable}
\clearpage
\subsection{Test di \glossterm{sistema}}
\renewcommand{\arraystretch}{2.5}
\rowcolors{2}{gray!20}{white}
\begin{longtable}{|>{\centering}p{2cm}|>{\RaggedRight}m{12cm}|>{\centering\arraybackslash}p{2cm}|}
    \hline
    ...
    un grafico in formato di tipo \glossterm{Gauge} rappresentante la media aritmetica della temperatura,
    ...
    un grafico in formato di tipo \glossterm{Gauge} rappresentante la media aritmetica dell'umidità,
    ...
    un grafico in formato di tipo \glossterm{Gauge} rappresentante la media aritmetica della temperatura percepita,
    ...
    un grafico in formato di tipo \glossterm{time series} rappresentante l'intensità delle precipitazioni
    ...
    un grafico in formato di tipo \glossterm{time series} rappresentante la quantità di polveri sottili presenti nell'aria,
    ...
    un grafico in formato di tipo \glossterm{time series} rappresentante le misurazioni relative al livello dell'acqua,
    ...
    un grafico in formato di tipo \glossterm{Gauge} rappresentante l'attuale intensità delle precipitazioni,
    ...
    un grafico in formato di tipo \glossterm{Gauge} rappresentante l'attuale inquinamento dell'aria,
    ...
    un grafico in formato di tipo \glossterm{Gauge} rappresentante l'attuale livello dell'acqua,
    ...
    \hline
    TS-24 & 
    Verificare che l'amministratore pubblico possa visualizzare un pannello \glossterm{geomap} che evidenzi i guasti nella rete eletrica, nella \glossterm{dashboard} relativa ai dati urbanistici.& NI \\
    \hline
    TS-25 & 
    Verificare che l'amministratore pubblico possa visualizzare un pannello in formato \glossterm{time series} rappresentante il riempimento di un'isola ecologica, espresso in percentuale, nella \glossterm{dashboard} relativa ai dati urbanistici.& NI \\
    \hline
    TS-26 & 
    Verificare che l'amministratore pubblico possa visualizzare un pannello \glossterm{geomap} che evidenzi lo stato di disponibilità delle colonnine di ricarica, nella \glossterm{dashboard} relativa ai dati urbanistici.& NI \\
    \hline
    TS-27 & 
    ...
    \hline
    TS-28 & 
    Verificare che l'amministratore pubblico possa visualizzare un pannello nel formato \glossterm{time series} rappresentante l'andamento dei consumi delle colonnine di ricarica, espresso in kilowattora (kWh), nella \glossterm{dashboard} relativa ai dati urbanistici.& NI \\
    \hline
    TS-29 & 
...
\end{longtable}
\clearpage
\subsection{Test di accettazione}\label{sec:test accettazione}
Questa sezione presenta i \glossterm{test} di accettazione del software, condotti da NaN1fy e dalla
...
\begin{longtable}{|>{\centering}p{2cm}|>{\RaggedRight}m{12cm}|>{\centering\arraybackslash}p{2cm}|}
    ...
    \hline
    TA-08 &
    Verificare che un sensore, una volta connesso al \glossterm{sistema}, possa:
    \begin{enumerate}
