% changelog: "0.0.0, 2024-04-05, Oscar Konieczny, Prima stesura del verbale"
...
L'incontro è iniziato con la discussione degli incontri avvenuti il giorno precedente. In particolare si è discusso su come procedere in vista del prossimo SAL fissato con \texttt{Sync Lab}. Successivamente sono stati divisi i compiti per le seguenti due settimane, corrispondenti al primo sprint.
...
\begin{table}[ht!]
	...
	\begin{tabular}{lcl}
		...
		Stesura codice generatore dati Python & 1 [SyncCity] & Pietro Busato, Guglielmo Barison\\
		\bottomrule
	\end{tabular}
