% changelog: "1.0.0, 2024-06-23, Approvazione per RTB"
...
% -- TITOLO INTESTAZIONE -- %
\newcommand{\customtitle}{VERBALE INTERNO DEL 2024-06-21} % o ESTERNO
...
\begin{titlepage}
	...
	\begin{center}
		\begin{flushright}
			{\fontsize{30pt}{52pt}\selectfont \textbf{Verbale Interno Del\\2024-06-21\\}} % o ESTERNO
		\end{flushright}
		\vspace{3cm}
	\end{center}
	\vspace{8.5 cm}
...
\begin{table}[ht!]	
	...
	\begin{tabular}{p{1.2cm} p{2cm} p{6cm} p{3cm} p{2cm}}
		...
		\midrule
			1.0.0 & 2024-06-24 & \textbf{Approvazione per RTB} & & \\\\
            0.0.1 & 2024-06-24 & Verifica completa, correzioni. & Veronica Tecchiati, Guglielmo Barison & Verificatore \\\\
			0.0.0 & 2024-06-23 & Stesura verbale. & Davide Donanzan & Redattore
 			\\ % spazio tra le righe
...
La riunione si è tenuta dopo l'incontro con l'azienda SyncLab con il SAL successivo fissato per il 2024-07-16. \\ 
...
Come d'accordo con l'azienda, il team affronterà un periodo di assestamento atto a mitigare le problematiche riscontrate nel sesto Sprint, in particolare l'occorrenza di impegni di studio che hanno impedito il normale avanzamento del progetto.\\
Non avendo ancora prefissato alcun obiettivo per il settimo Sprint, il preventivo verrà calcolato con cura e attenzione nel momento in cui i membri del gruppo daranno la propria disponibilità a dedicarsi al progetto, con una data limite fissata al 2024-07-05.
In conclusione, sono state delineate le slide per la presentazione relativa al colloquio con il Commitente per concludere la revisione RTB.
\subsection{Decisioni prese}
\begin{itemize}
	\setlength\itemsep{0em}
    \item Elezione del nuovo responsabile: Oscar Konieczny;
	\item Limite massimo di pausa per tutti i membri fissato al 2024-07-05.
...
Il team si riserva un periodo di pausa per la risoluzione dei problemi di studio individuati. A seguito della mitigazione di tale problematica, avverrà una completa analisi delle attività da svolgere e la conseguente suddivisione dei compiti.
\end{document}
