% changelog: "0.0.1, 2024-05-09, Guglielmo Barison, Prima stestura documento"
...
\begin{itemize}
	\setlength\itemsep{0em}
  \item Completare la stesura delle \textit{Norme di Progetto} in tempo ragionevole entro la fine della prossima settimana.
...
Non sono state stabilite ulteriori attività da svolgere.
\end{document}
