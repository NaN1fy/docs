...
\begin{table}[ht!]	
	...
	\begin{tabular}{p{1.2cm} p{2cm} p{6cm} p{3cm} p{2cm}}
		...
		\midrule
		0.0.1 & 2024-05-13 & Verifica completa e aggiunta informazione sulla discussione stato refactor del repository & Linda Barbiero & Verificatore \\
...
\\
Riguardante il tema dell refactor del repository di \textit{GitHub} per poter assegnare delle \textit{Epiche} alle attività,
il gruppo ha concluso come le priorità attualmente siano altre, scegliendo di procrastinare questo genere di miglioria al prossimo \textit{Sprint}.
