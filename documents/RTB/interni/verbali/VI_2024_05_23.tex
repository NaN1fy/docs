% changelog: "0.0.1, 2024-06-01, Correzioni minori, Oscar Konieczny"
...
\begin{table}[ht!]	
	...
	\begin{tabular}{p{1.2cm} p{2cm} p{6cm} p{3cm} p{2cm}}
		...
		\midrule
		0.0.1 & 2024-06-01 & Correzioni minori. & Oscar Konieczny & Verificatore \\
...
del generatore dati e la necessità di proseguire con le migliorie alle dashboard \glossterm{Grafana} durante la settimana successiva.
In merito alla riscrittura di una consistente porzione del codice Python precedentemente prodotto, si rimanda al \textit{[Nome verbale]\textunderscore  v1.0.0} del 2024-05-23 per un esame più accurato delle problematiche da essa derivate. \\
