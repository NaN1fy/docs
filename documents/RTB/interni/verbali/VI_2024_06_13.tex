...
\begin{table}[ht!]	
	...
	\begin{tabular}{p{1.2cm} p{2cm} p{6cm} p{3cm} p{2cm}}
		...
		\midrule
	  		1.0.0 & 2024-06-13 & \textbf{Approvazione per RTB} & & \\\\ % spazio tra le righe
			0.0.1 & 2024-06-23 & Verifica del documento e modifiche minori. & Davide Donanzan, Gugelilmo Barison & Verificatore \\\\ % spazio tra le righe
