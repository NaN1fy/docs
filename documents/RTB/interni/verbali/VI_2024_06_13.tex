% changelog: "0.0.0, 2024-06-13, Oscar Konieczny, Stesura del verbale"
...
Come da scaletta precedentemente definita, la riunione è iniziata con la scelta dello stesore di questo verbale, per poi continuare con la discussione delle attività che i membri hanno svolto dall'ultimo incontro realizzato. In particolare si è parlato dei nuovi sensori implementati e del progresso che è stato svolto a riguardo del sistema di alerting, soffermandosi su alcuni dubbi che sono stati riscontrati nello sviluppo di quest'ultimo. La riunione è poi proseguita con la decisione delle prossime attività da svolgere. Per giunta sono stati raccolti una serie di dubbi da porre alla Proponente tramite il canale communicativo che è stato messo a disposizione. La riunione si è conclusa con la preparazione al diario di bordo del giorno a seguire.
