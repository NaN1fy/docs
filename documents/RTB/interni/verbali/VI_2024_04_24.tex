% changelog: "0.0.2, 2024-04-26, Oscar Konieczny, Verifica completa con aggiunte minori"
...
\begin{itemize}
	...
	\item\textbf{Luogo:} Chiamata \texttt{\glossterm{Discord}};
...
\begin{table}[ht!]
	...
	\begin{tabular}{p{7cm}cp{7cm}}
		...
		\midrule
		Continuazione ``Glossario" & \href{https://github.com/NaN1fy/docs/issues/14}{\underline{14}} & Guglielmo Barison, Oscar Konieczny\\\\
		Continuazione ``Analisi dei requisiti" & \href{https://github.com/NaN1fy/docs/issues/15}{\underline{15}} & Davide Donanzan, Veronica Tecchiati\\\\
		Continuazione ``Piano di progetto"  & \href{https://github.com/NaN1fy/docs/issues/16}{\underline{16}} & Linda Barbiero, Veronica Tecchiati\\\\
		Continuazione ``Piano di qualifica" & \href{https://github.com/NaN1fy/docs/issues/17}{\underline{17}} & Davide Donanzan, Guglielmo Barison\\\\
		Continuazione ``Norme di progetto" & \href{https://github.com/NaN1fy/docs/issues/20}{\underline{20}} & Linda Barbiero, Pietro Busato\\\\
		Visualizzazione dati su dashboard \texttt{\glossterm{Grafana}} & \href{https://github.com/NaN1fy/SyncCity/issues/3}{\underline{3*\tnote{*}}} & Davide Donanzan, Linda Barbiero\\\\
		Integrazione \texttt{\glossterm{Kafka}} e \texttt{\glossterm{ClickHouse}} & \href{https://github.com/NaN1fy/SyncCity/issues/4}{\underline{4*\tnote{*}}} & Guglielmo Barison, Oscar Konieczny, Pietro Busato\\\\
		Integrazione generatore dati con \texttt{\texttt{\glossterm{Kafka}}} & \href{https://github.com/NaN1fy/SyncCity/issues/5}{\underline{5*\tnote{*}}} & Davide Donanzan, Guglielmo Barison\\\\
		Stesura diagramma funzionamento generatore dati \texttt{\glossterm{Python}} & \href{https://github.com/NaN1fy/SyncCity/issues/6}{\underline{6*\tnote{*}}} & Davide Donanzan, Guglielmo Barison\\\\
		\bottomrule
	\end{tabular}
	\begin{tablenotes}
		\vspace{1em}
