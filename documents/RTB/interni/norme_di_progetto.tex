...
\hypersetup{hidelinks}
	...
	\begin{tabular}{p{1.2cm} p{2cm} p{6cm} p{3cm} p{2cm}}
      ...
      0.9.0 & 2024-05-30 & Stesura sottosezione \ref{sec:doc}. & Pietro Busato & Redattore \\\\
        ...
        0.7.1 & 2024-05-29 & Aggiunta diagrammi UML in sezione \ref{sec:analisi-rischi}. & Veronica Tecchiati & Redattore \\\\
...
Il \glossterm{processo} primario di fornitura, definito dallo standard
...
\glossterm{Discord}, è accompagnato anche dalla possibilità di comunicare con la Proponente via
...
\begin{itemize}
    ...
    \item \textbf{\glossterm{Test}:} piano di testing che verrà utilizzato per garantire la correttezza finale del prodotto, comprendente test di unità, di integrazione, di sistema e di accettazione.
\end{itemize} 
...
Attraverso la piattaforma \glossterm{GitHub}, ogni attività prevista viene affiancata da una issue a
...
Questo processo trae le sue basi dai vincoli di qualità e dalle linee guida individuate all'interno
...
\begin{itemize}
  \item Discussione da parte di ognuno sulle proprie task assegnate con retrospettiva in merito
...
Le riunioni esterne avvengono prevalentemente tra committente e \glossterm{Proponente} ogni due
...
\begin{itemize}
  ...
  \end{itemize}
\end{itemize}
\subsubsubsection{Gestione delle task} \label{sec:gestione_task}\\
...
\begin{itemize}
    \item \textbf{Todo}: contiene task da fare in base allo \glossterm{Sprint} corrente. Durante la fase di Sprint Planning sono state definite ed ognuna preassegnata ad almeno un membro, il quale si occuperà del suo ciclo di vita.
