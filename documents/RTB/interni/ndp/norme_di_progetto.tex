...
\begin{table}[ht!]	
	...
	\begin{tabular}{p{1.2cm} p{2cm} p{6cm} p{3cm} p{2cm}}
		...
		0.3.0 & 2024-04-29 & Contuniazone sottosezione "Coordinamento" (Riunioni e Reperibilità) e stesura sezioni "Miglioramento" e "Formazione". & Linda Barbiero & Redattore \\\\ % spazio tra le righe
