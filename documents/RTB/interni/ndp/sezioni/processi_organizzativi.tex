...
Le comunicazioni esterne con il committente e \glossterm{proponente} vengono considerate ovviamente di importanza maggiore, dunque trattate col rispetto dovuto.\\
...
Le riunioni esterne avvengono prevalentemente tra committente e \glossterm{proponente} con cadenza bisettimanale/trisettimanale. Vengono utilizzate come incontri di \glossterm{SAL}, e come deadline degli \glossterm{sprint}.\\
...
\begin{itemize}
	...
	\begin{itemize}
    \item{Pianifica lo \glossterm{sprint} definendo le task relative, definendo il preventivo ore e costì}
...
\begin{itemize}
  \item{Creazione: la task definita viene aperta come \glossterm{issue} su GitHub.}
  \item{Assegnazione: la task viene assegnata ad uno o più membri del gruppo.}
  \item{Completamento: la task viene completata, prevalentemente su un \glossterm{branch} distinto dal principale.}
...
\begin{itemize}
  \item{\textbf{Sprint Planning:} Pianificazione dello sprint, in concomitanza con il suo inizio. Gli incontri di \glossterm{SAL} vengono utilizzati come punto di riferimento di conclusione dello Sprint e inizio del successivo.}
  \begin{itemize}
    ...
    \item{Definizione di obiettivi concreti e di \glossterm{issue} relative, definendole su \glossterm{GitHub}.}
...
\begin{itemize}
  \item \textbf{Todo}: contiene task da fare in base allo \glossterm{sprint} corrente. Durante la fase di \texttt{Sprint Planning} sono state definite ed ognuna preassegnata ad almeno un membro, il quale si occuperà del suo ciclo di vita.
  ...
  \item \textbf{Done}: contiene task completate, verificate e accettate. In prossimità del prossimo sprint, vengono archiviate le task completate relative a sprint precedenti così da non sovraffollare la \glossary{board}.
\end{itemize}
\medskip
...
\end{itemize}
\medskip
Viene utilizzato questo strumento anche per la \textbf{comunicazione asincrona} con l'azienda \glossterm{proponente} nel loro canale personale.
...
\begin{itemize}
  \item \textbf{Meeting Esterni}: con \glossterm{proponente} o committente;
...
Strumento di videochiamata utilizzato principalmente per la comunicazione esterna con committente e \glossterm{proponente}.
...
\begin{itemize}
  \item{\textbf{\glossterm{LaTeX}:}} https://www.overleaf.com/learn.
  \item{\textbf{\glossterm{Git}:}} https://docs.github.com/en/get-started/using-git/about-git.
  \item{\textbf{\glossterm{GitHub}:}} https://docs.github.com.
