% changelog: "0.0.0, 2024-03-25, Stesura del verbale"
...
\begin{table}[ht!]	
	...
	\begin{tabular}{p{1.2cm} p{2cm} p{6cm} p{3cm} p{2cm}}
		...
		\midrule
		% \\\\ % spazio tra le righe
		0.0.0 & 2024-03-19 & Stesura del verbale & Linda Barbiero & Redattore \\
		\bottomrule
...
Si è iniziata la riunione discutendo nel dettaglio ogni punto della valutazione della candidatura, ponendo attenzione sulle criticità esposte. Si sono dunque decisi gli effettivi cambiamenti da apportare e il come apportarli. Infine, si è discusso internamente riguardo la suddivisione dei documenti interessati, sia come redattori che come verificatori.
...
\begin{table}[ht!]
	\centering
	\begin{tabular}{p{6cm} >{\centering\arraybackslash}p{1.5cm} p{3cm} p{3.5cm}}
		\toprule
		\textbf{Titolo} & \textbf{\# Issue} & \textbf{Redattori} & \textbf{Verificatori} \\
		\midrule
		Modifica documento di dichiarazione impegni & 10 & Guglielmo Barison & Pietro Busato, Davide Donanzan\\\\
		Modifica lettera di presentazione & 11 & Davide Donanzan & Pietro Busato, Linda Barbiero\\\\
		\bottomrule
	\end{tabular}
